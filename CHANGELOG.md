...
- Updated CI workflows to skip Claude code review when actor is claude[bot] to prevent conflicts.
- Made code review workflow non-blocking to avoid preventing PR merges.
- Added documentation test for verifying Claude review workflow behavior.
